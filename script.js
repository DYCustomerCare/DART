...
const templates = [
    ...
    new template (
        ...
        warning = "The Order number and Tracking number is always required.<br>
        <i class="bi bi-exclamation-circle-fill"></i> Proof of value/receipt is always required for any sort of lost package/missing contents claim.<br>
        <i class="bi bi-exclamation-circle-fill"></i> Images of the parcel upon receipt are required for missing contents claims.<br>
        <i class="bi bi-exclamation-circle-fill"></i> If a shipment had more than one portion (ex. one BOSS, one NJW) then we must be provided precise information with details of which proof of value pertains to which tracking number.<br><br>If <b>$500 Or Less</b>, please allow <b>48 Hours</b> for the package to appear<br>before requesting a replacement from management.",
        filter = "fedex",
        assign = "Logistics",
        assignType = 2,
